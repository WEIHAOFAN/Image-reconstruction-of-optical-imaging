function [Output_FW, Output_FV, Output_LE, Output_ER, Output_Norm, Output_Signal, Output_Noise, Output_SNR] = PlotSlices_metrics_noise_neuroDOT(fooV, info, keep1, keep2, aWL1, aWL2, iAWL1, iAWL2, frequency, ROI, Extco, p_HbO, p_HbR)
